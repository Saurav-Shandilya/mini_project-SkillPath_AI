...
const Landing = () => {
    ...
    const steps = [
        {
            ...
            title: "Upload Resume & Goal",
            desc: "Enter your target career or upload your resume for instant AI gap analysis.",
            color: "from-blue-500 to-cyan-500"
        },
        {
            icon: <Brain className="w-8 h-8" />,
            title: "AI Generates Syllabus",
            desc: "Our engine builds a hyper-customized course structure covering exactly what you need.",
            color: "from-purple-500 to-pink-500"
        },
        {
            icon: <LayoutDashboard className="w-8 h-8" />,
            title: "Enter the Lab",
            desc: "Learn in our immersive, split-pane environment featuring an interactive browser terminal.",
            color: "from-cyan-500 to-blue-500"
        },
        {
            icon: <CheckCircle2 className="w-8 h-8" />,
            title: "Complete Micro-Tasks",
            desc: "Execute code and check off AI-generated practical tasks to build real experience.",
    ...
    return (
        <div className="min-h-screen bg-[#0B0F1A] text-white overflow-x-hidden font-sans selection:bg-cyan-500/30">
            ...
            {/* Navigation */}
            <motion.nav
                className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#0B0F1A]/90 backdrop-blur-xl border-b border-white/10' : 'bg-transparent'
                    }`}
                initial={{ y: -100 }}
                animate={{ y: 0 }}
            ...
            <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-[#0B0F1A]/80 via-[#0B0F1A]/40 to-[#0B0F1A] z-10 pointer-events-none" />

                {/* Strong central glow to separate text from background nodes */}
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[500px] bg-[#0B0F1A]/90 blur-[100px] z-10 pointer-events-none rounded-full" />
                ...
                <div className="relative z-20 max-w-5xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl md:px-0 text-gray-400 max-w-3xl mx-auto leading-relaxed">
                            SkillPath AI analyzes your resume, detects gaps, and drops you into a fully immersive, zero-setup coding lab to conquer custom-generated tasks.
                        </p>
