            ...
            <div className="max-w-6xl mx-auto py-6">
                ...
                <div className="mb-8 md:mb-12 flex flex-col md:flex-row md:justify-between items-start md:items-end gap-6 md:gap-0">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto mt-4 md:mt-0">
                        <button onClick={() => navigate('/resume-analyzer')} className="glass px-6 py-3 rounded-2xl flex items-center justify-center gap-3 border-blue-500/20 bg-blue-500/5 hover:bg-blue-500/10 transition-colors w-full sm:w-auto">
                            <Target className="text-blue-400 w-5 h-5 shrink-0" />
                            <span className="text-blue-400 font-bold tracking-wider">Launch Resume Analyzer</span>
                        </button>
