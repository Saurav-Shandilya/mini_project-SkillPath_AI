    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0B0F1A] p-4 overflow-hidden relative">
            ...
            <motion.div
                ...
                className="glass-card w-full max-w-md p-8 pt-10 relative z-10"
            >
                {/* Back Button */}
                <div className="absolute top-4 left-6">
                    <Link to="/" className="text-gray-400 hover:text-white flex items-center gap-2 text-sm transition-colors group">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="relative">
                        <UserIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-secondary w-5 h-5" />
                        <input
                            type="text"
                    ...
                    >
                        ...
                        {!loading && <motion.span animate={{ x: [0, 5, 0] }} transition={{ repeat: Infinity, duration: 1 }}>→</motion.span>}
                    </button>
