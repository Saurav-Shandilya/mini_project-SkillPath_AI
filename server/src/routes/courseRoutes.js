...
import { generateDiagnosticTest, analyzeSkillGap, generateCourseStructure, enrollInCourse, updateModuleStatus, updateModuleTaskStatus, generateModuleContent, generateChapterQuiz, submitChapterQuiz, getChapterVideo, dropCourse } from '../controllers/courseController.js';
...
router.put('/update-task', protect, updateModuleTaskStatus);
